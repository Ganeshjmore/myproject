...
import com.ubs.dashboard.repository.CommentRepository;
import com.ubs.dashboard.service.dto.CommentDTO;
import com.ubs.dashboard.service.mapper.CommentMapper;
...
class CommentResourceIT {
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment().text(DEFAULT_TEXT).createdAt(DEFAULT_CREATED_AT);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity(EntityManager em) {
        Comment comment = new Comment().text(UPDATED_TEXT).createdAt(UPDATED_CREATED_AT);
        return comment;
    }
    ...
    void putNewComment() throws Exception {
        ...
        updatedComment.text(UPDATED_TEXT).createdAt(UPDATED_CREATED_AT);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.text(UPDATED_TEXT).createdAt(UPDATED_CREATED_AT);
