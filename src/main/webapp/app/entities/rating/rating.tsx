          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('ratedAt')}>
                  Rated At <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {ratingList.map((rating, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{rating.score}</td>
                  <td>{rating.level}</td>
                  <td>{rating.ratedAt ? <TextFormat type="date" value={rating.ratedAt} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{rating.resource ? <Link to={`/resource/${rating.resource.id}`}>{rating.resource.id}</Link> : ''}</td>
                  <td>{rating.objective ? <Link to={`/objective/${rating.objective.id}`}>{rating.objective.id}</Link> : ''}</td>
