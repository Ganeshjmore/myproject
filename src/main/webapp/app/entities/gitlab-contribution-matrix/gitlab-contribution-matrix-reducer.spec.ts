...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './gitlab-contribution-matrix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GITLABCONTRIBUTIONMATRIX_LIST actions', async () => {
    ...
    it('dispatches FETCH_GITLABCONTRIBUTIONMATRIX actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GITLABCONTRIBUTIONMATRIX actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GITLABCONTRIBUTIONMATRIX actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GITLABCONTRIBUTIONMATRIX actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GITLABCONTRIBUTIONMATRIX actions', async () => {
      const expectedActions = [
        {
