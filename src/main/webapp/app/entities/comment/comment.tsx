            ...
            <tbody>
              {commentList.map((comment, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{comment.resource ? <Link to={`/resource/${comment.resource.id}`}>{comment.resource.id}</Link> : ''}</td>
                  <td>{comment.objective ? <Link to={`/objective/${comment.objective.id}`}>{comment.objective.id}</Link> : ''}</td>
