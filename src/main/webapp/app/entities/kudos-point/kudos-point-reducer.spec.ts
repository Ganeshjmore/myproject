...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KUDOSPOINT_LIST actions', async () => {
    ...
    it('dispatches FETCH_KUDOSPOINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_KUDOSPOINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_KUDOSPOINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_KUDOSPOINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_KUDOSPOINT actions', async () => {
      const expectedActions = [
        {
