...
export const ObjectiveDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(objectiveEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="managerDashboardApp.objective.delete.question">Are you sure you want to delete this Objective?</ModalBody>
      <ModalFooter>
...
export default ObjectiveDeleteDialog;
