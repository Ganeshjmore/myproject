...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './objective.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OBJECTIVE_LIST actions', async () => {
    ...
    it('dispatches FETCH_OBJECTIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OBJECTIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OBJECTIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OBJECTIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OBJECTIVE actions', async () => {
      const expectedActions = [
        {
