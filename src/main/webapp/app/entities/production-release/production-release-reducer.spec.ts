...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './production-release.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTIONRELEASE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRODUCTIONRELEASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRODUCTIONRELEASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRODUCTIONRELEASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTIONRELEASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRODUCTIONRELEASE actions', async () => {
      const expectedActions = [
        {
